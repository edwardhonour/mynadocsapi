...
function getMonthId() {
      ...
      if ($current_month=="2023-01") $current_month_id="2023-02";
      if ($current_month=="2023-02") $current_month_id="2023-03";
...
function getEFTReportExcel($billingCycle)
{
	$X=new XRDB();


$spreadsheet = new Spreadsheet();
$spreadsheet->getActiveSheet()->setTitle('EFT Report');
...
$styleArrayLine = [
	...
	$spreadsheet->getActiveSheet()->getColumnDimension('D')->setWidth(25);
        ...
        $spreadsheet->getActiveSheet()->getStyle('D1')->getFill()->getStartColor()->setARGB('FFFFCC66');
        $spreadsheet->getActiveSheet()->getStyle('D1')->getAlignment()->setWrapText(true);
	$spreadsheet->getActiveSheet()->setCellValue('D1', "Invoice Total");
	...
	$spreadsheet->getActiveSheet()->getColumnDimension('E')->setWidth(25);
        ...
        $spreadsheet->getActiveSheet()->getStyle('E1')->getFill()->getStartColor()->setARGB('FFFFCC66');
        $spreadsheet->getActiveSheet()->getStyle('E1')->getAlignment()->setWrapText(true);
	$spreadsheet->getActiveSheet()->setCellValue('E1', "Billing Date");
	...
	$spreadsheet->getActiveSheet()->getColumnDimension('F')->setWidth(25);
        ...
        $spreadsheet->getActiveSheet()->getStyle('F1')->getFill()->getStartColor()->setARGB('FFFFCC66');
        $spreadsheet->getActiveSheet()->getStyle('F1')->getAlignment()->setWrapText(true);
	$spreadsheet->getActiveSheet()->setCellValue('F1', "Due Date");

	$sql="select company_id, company_name, invoice_number, grand_total, billing_date, due_date from nua_company_invoice where company_id in (select id from nua_company where flag_eft in ('Y','Yes','YES','y')) and month_id = '".$billingCycle."' order by company_name";
	$eft=$X->sql($sql);
        ...
        foreach($eft as $eftRow) {
            ...
            $cell="E".$row;
                $spreadsheet->getActiveSheet()->getStyle($cell)->applyFromArray($styleArrayLine);
	        $spreadsheet->getActiveSheet()->setCellValue($cell, $eftRow['billing_date']);
...
$sql="select * from nua_employee where social_security_number = '" . $data['social_security_number'] . "' and company_id = " . $company_id;
            ...
            if ($data['min_month_id']=="2023-01") $eff_dt="01/01/2023";
            if ($data['min_month_id']=="2023-02") $eff_dt="02/01/2023";
            ...
            if ($data['max_month_id']=="2023-01") $ter_dt="01/31/2022";
            if ($data['max_month_id']=="2023-02") $ter_dt="02/28/2022";
