...
if ( $xlsx = SimpleXLSX::parse($target_file) ) {
	...
	$post['current_provider']=$Company_B[16];
	...
	$post['billing_contact_email']=strtolower($Company_E[18]);	
	$post['billing_contact_phone']=strtolower($Company_E[19]);
